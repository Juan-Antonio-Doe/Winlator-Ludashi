...
public abstract class Atom {
    private static final ArrayList<String> atoms = new ArrayList<>(Arrays.asList(null,
            ...
            "SUPERSC.LPT_X", "SUPERSC.LPT_Y", "SUBSC.LPT_X", "SUBSC.LPT_Y", "UNDERLINE_POSITION",
            ...
            // Expanded atom list using values from Brunodev85's updated implementation (LGPL-2.1).
            "_MOTIF_WM_HINTS", "_NET_WM_PID", "_NET_WM_WINDOW_TYPE", "_NET_WM_HWND", "_NET_WM_WOW64",
            "_NET_WM_SURFACE", "_NET_WM_GPU_INFO"));
